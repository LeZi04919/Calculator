...
namespace WindowsFormsApp1
{
    public partial class Form2 : Form
    {
        ...
        public void Download()
        {
            ...
            HttpWebRequest req = (HttpWebRequest)WebRequest.CreateDefault(new Uri("https://cannon.org.cn/version.txt"));
            req.Method = "HEAD";//请求头
            ...
            if (statusCode == "OK" && Form1.get_c == false)
            {
                ...
                else
                {
                    ...
                    //ServicePointManager.ServerCertificateValidationCallback = delegate { return true; };
                    HttpWebRequest request = (HttpWebRequest)WebRequest.Create("https://cannon.org.cn/c_update_status.txt");
                    ServicePointManager.ServerCertificateValidationCallback = delegate { return true; };
                    //vulue = 15;
                    //ServicePointManager.ServerCertificateValidationCallback = delegate { return true; };
